...
#Fit a logistic regression to model the food security status of the individual on the other variables. Please present the model output. Briefly discuss and motivate the choice of this model and indicate whether an alternative approach could be adopted.
